...
use data/2000/all2000, clear 

replace female=(sex==2)
...
keep rmsa imm female logwage2 wt p1-p10 dev devsq c age ///
  grade educ educ exp exp2 exp3 inschool dropout somecoll collplus advanced ///
...
save data/2000/supp2000.dta, replace 
