...
gen hrswkly = .
replace hrswkly = annhrs / weeks if annhrs > 0 & annhrs != . 
...
gen year = 1990;
save data/1990/cell_all.dta, replace;
#delimit cr
restore 
...
gen year = 1990;
gen male = 1;
save data/1990/cell_male.dta, replace;
#delimit cr
restore 
...
gen year = 1990;
gen male = 0;
save data/1990/cell_female.dta, replace;
#delimit cr
restore 
...
gen native = 1;
gen male = 1;
save data/1990/cell_native_male.dta, replace;
#delimit cr
restore 
...
gen native = 1;
gen male = 0;
save data/1990/cell_native_female.dta, replace;
#delimit cr
restore 
...
gen native = 0;
gen male = 1;
save data/1990/cell_imm_male.dta, replace;
#delimit cr
restore 
...
gen native = 0;
gen male = 0;
save data/1990/cell_imm_female.dta, replace;
#delimit cr
restore 
