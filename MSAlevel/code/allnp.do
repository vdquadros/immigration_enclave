...
rename (metaread yrimmig) (msa immyr) 
...
gen selfemp = 0
replace selfemp = 1 if (abs(selfinc) > 0)
...
replace yrsinus = 2005 - immyr if year == 2005 & imm == 1
replace yrsinus = 2006 - immyr if year == 2006  & imm == 1

/* recent immigrant */
replace recimm = (0 <= yrsinus & yrsinus <= 10) 
...
keep rmsa imm female logwage2 wt p1-p10 dev devsq c age ///
	...
	eclass incwage wkswork1 selfinc wage wage2 emp
	
save data/supp0506.dta, replace 
