...
use data/1980/ic_city_test.dta
gen d = 1
sort d
save data/1980/temp.dta, replace
restore 
...
forv s = 2/16{
	merge rczone using data/inflow_skill`s'
	drop _merge
	sort rczone
