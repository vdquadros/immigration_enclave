*allnp2 based on reswageim.sas  follows read2005/06 and assign_pumas;


options ls=100 nocenter;
libname acs '/var/tmp/card/';
libname here '.'; 

*follows read2005, read2006, assign_pumas;
...
%include '~/cpr/acs/msarecode_acs.sas';

grade=educ;
length grade educ eclass dropout hsgrad somecoll collplus exp xclass 3;
...
length annhrs chours selfemp workly ft d2005 3;
...
length ic euro hi_asian mid_asian 3;
...
if year=2005 then yrsinus=2005-immyr;
else if year=2006 then yrsinus=2006-immyr;
...
keep rmsa imm female logwage2 wt p1-p10 dev devsq c age 
              ...
              eclass d2005 wagesal weeks selfinc wage wage2 emp;
