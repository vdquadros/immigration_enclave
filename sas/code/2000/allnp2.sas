*allnp2.sas  - prepare for dfl by city;

*revised dec 27 to move educ=10 to some coll;
...
data c2000.supp2000;
set c2000.all2000 (drop=famrel ownchild
age_alloc numrace marstat educ_alloc
citizen ind occ class totearn);
...
keep rmsa imm female logwage2 wt p1-p10 dev devsq c age 
              ...
              pre_exp pre_exp1 pob state msa nonmover 
              ic euro hi_asian mid_asian mex owage annhrs xclass 
              eclass wagesal weeks selfinc wage wage2 emp grade;
