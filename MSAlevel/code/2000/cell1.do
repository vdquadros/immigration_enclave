...
gen native = 1
gen male = 1
save compvar_nm2000.dta, replace
restore 
...
gen native = 1
gen male = 0
save compvar_nf2000.dta, replace
restore 
...
gen native = 0
gen male = 1
save compvar_im2000.dta, replace
restore 
...
gen native = 0
gen male = 0
save compvar_if2000.dta, replace
restore 

clear
append using compvar_nm2000.dta compvar_nf2000.dta compvar_im2000.dta compvar_if2000.dta
keep year native male v vres 
order year native male v vres 
save data/2000/compvar_2000.dta, replace

erase nm2.dta 
erase nf2.dta
erase im2.dta 
erase if2.dta
erase compvar_nm2000.dta 
erase compvar_nf2000.dta 
erase compvar_im2000.dta 
erase compvar_if2000.dta
