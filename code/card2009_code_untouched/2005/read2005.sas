*read2005.sas - reads acs 2005 and converts vars to 2000 census format;

options ls=100 nocenter;
libname here '.';

libname acs '~/data/census/acs/2005';
libname keep '/tmp';
...
proc freq;
tables state imm*poor english*imm 
    age qob race1 black white female sex citizen immyr pob english 
    language marstat 
    mob1 migstate veteran famrel
    enrolled grade educ esr disability hispanic class 
