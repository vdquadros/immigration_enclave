...
collapse (mean) emp havewage2 wagesal cwagesal annhrs cannhrs weeks 
    ...
    black hispanic asian euro hi_asian mid_asian mex rmsa0 rmsa1 q1-q5 q1c 
    q2c q3c q4c q5c imm female wage2 logwage2 
    (sum) count=c [fweight = wt], by(rmsa eclass);
save data/2000/allcells_new1.dta, replace;
#delimit cr
restore 
...
save data/2000/allcells_new2.dta, replace;
#delimit cr
restore 
...
gen year = 2000;
save data/2000/cell_all.dta, replace;
#delimit cr
restore 
...
gen year = 2000;
gen male = 1;
save data/2000/cell_male.dta, replace;
#delimit cr
restore 
...
gen year = 2000;
gen male = 0;
save data/2000/cell_female.dta, replace;
#delimit cr
restore 
...
gen native = 1;
gen male = 1;
save data/2000/cell_native_male.dta, replace;
#delimit cr
restore 
...
gen native = 1;
gen male = 0;
save data/2000/cell_native_female.dta, replace;
#delimit cr
restore 
...
gen native = 0;
gen male = 1;
save data/2000/cell_imm_male.dta, replace;
#delimit cr
restore 
...
gen native = 0;
gen male = 0;
save data/2000/cell_imm_female.dta, replace;
#delimit cr
restore 
