...
%include '~/cpr/c80/smsarecode80.sas ';
length top125 3;
...
else if (700<=pob<=720) or (722<=pob<=732) or/Users/victoriadequadros/projects/immigration_enclave/code/card2009_code_untouched/1980/allnp2.sas
