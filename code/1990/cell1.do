...
save data/1990/nm2.dta, replace
restore
...
predict pred if e(sample)
predict res, residuals
save data/1990/nf2.dta, replace
restore
...
predict pred if e(sample)
predict res, residuals
save data/1990/im2.dta, replace
restore
...
predict pred if e(sample)
predict res, residuals
save data/1990/if2.dta, replace
restore

local files nf2 im2 if2
use data/1990/nm2.dta, clear
forv i=1/3{
	local f : word `i' of `files'
	append using data/1990/`f'.dta
}
