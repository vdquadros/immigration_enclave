...
save data/1980/bigcells.dta, replace
restore
...
save data/1980/bigcells_new1.dta, replace
restore
...
collapse (sum) count = c (mean) logwage2 lw2sq res ressq pred predsq respred imm ///
		female educ exp c dropout hs somecoll collplus college advanced [fweight = wt], ///
		by(rmsa native male)
save data/1980/bigcells_new2.dta, replace
restore
...
gen native = 0
gen male = 0
save compvar_if80.dta, replace
restore 

clear
append using compvar_nm80.dta compvar_nf80.dta compvar_im80.dta compvar_if80.dta
keep year native male v vres 
order year native male v vres 
save data/1980/compvar_1980.dta, replace

erase nm2.dta 
erase nf2.dta
erase im2.dta 
erase if2.dta
erase compvar_nm80.dta 
erase compvar_nf80.dta 
erase compvar_im80.dta 
erase compvar_if80.dta
